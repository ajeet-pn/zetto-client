const PrivecyPolicy = () => {
  return (
    <div className="privacy-policy-page">
        <div class="flex flex-col w-full"><div class="flex items-center w-screen lg:w-full rounded-t-[4px] h-8 bg-skin-page-header text-center mt-[100px] md:mt-[100px]"><div class="md:inline-flex gap-4 justify-between ml-10 mr-3 hidden items-center"><a href="/"><img class="HomePage w-[15px] h-[15px] noradius" src="/zetto/svg/home-icon.png" alt=""/></a> <img class="HomePage w-[14px] h-[10px] mt-0.5 rotate-90" src="/zetto/svg/arrow1.png" alt=""/></div> <div class="text-skin-page-header-txt ml-2 md:ml-0 font-semibold text-[15px]">KYC and Privacy Policy</div></div> <div class="text-black bg-white flex flex-col px-2 py-2 lg:px-28 content"><h1 style={{textAlign: "center"}}>PRIVACY POLICY ZETTO</h1>
<p>&nbsp;</p>
<p><strong>1. PRIVACY</strong></p>
<p>Never Ending Gaming N.V is committed to protecting your personal information. This Privacy Policy lets you know what information we collect when you use our services, why we collect this information and how we use the collected information.</p>
<p>&nbsp;</p>
<p>Please note that this Privacy Policy will be agreed between you and . (‘We’, ‘Us’ or ‘Our’, as appropriate). This Privacy Policy is an integrated part of ’s Terms and Conditions.</p>
<p>&nbsp;</p>
<p>The website www.zetto.in ("Casino", "Website", “Never Ending Gaming N.V..”, "We", "Us", "Our") is owned and operated by Never Ending Gaming N.V a Never Ending Gaming N.V.. registered in accordance with Curaçao Law, registration No 162816, Address: Abraham de Veerstraat 9, Curacao. is licensed and regulated by the Curacao Gaming Authority and operates under the License No. 365/JAZ issued to Gaming Services Provider, Authorized and Regulated by the Government of Curaçao.</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p><strong>5. CERTAIN EXCLUDED DISCLOSURES</strong></p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p><strong>Information placed on your device</strong></p>
...
<p>Strictly necessary cookies are essential to allow a user to move around a website and use its features, such as accessing secure areas of the website or making financial transactions. Without these cookies, we would not be able to make our websites work efficiently.</p>
<p>&nbsp;</p>
<p><strong>During the registration process</strong></p>
<p>These cookies will hold information collected during your registration and will allow us to recognize you as a customer and provide you with the services you require. We may also use this data to better understand your interests while online and to enhance your visits to our platforms.</p>
<p>&nbsp;</p>
<p><strong>On our website</strong></p>
<p>For visitors to our website, we use cookies to collect information. Our servers use three different types of cookies:</p>
<p>&nbsp;</p>
<p><strong>A ‘session-based’ cookie:</strong> This type of cookie is only allocated to your computer for the duration of your visit to our website. A session-based cookie helps you move around our website faster and, if you’re a registered customer, it allows us to give you information that is more relevant to you. This cookie automatically expires when you close your browser.</p>
<p>&nbsp;</p>
<p><strong>A ‘persistent’ cookie:</strong> This type of cookie will remain on your computer for a period of time set for each cookie. Flash cookies are also persistent.</p>
<p>&nbsp;</p>
<p><strong>‘Analytical’ cookies: </strong>This type of cookie allows us to recognize and count the number of visitors to our site and see how visitors use our services. These help us improve the way our sites work, for example, by ensuring you can find what you are looking for easily.</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p><strong>9. CONSENT TO SECURITY REVIEW</strong></p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p><strong>11. PROTECTION OF MINORS</strong></p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p><strong>13. THIRD-PARTY PRACTICES</strong></p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p><strong>14. LEGAL DISCLAIMER</strong></p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p><strong>15. CONSENT TO PRIVACY POLICY</strong></p>
<p>&nbsp;</p>
<p>Your use of our services constitutes an agreement to our Privacy Policy.&nbsp;This is our entire and exclusive Privacy Policy and it supersedes any earlier version. This Privacy Policy should be read in conjunction with our Terms and Conditions and any additional applicable terms posted on our platforms. We may periodically make changes to this Privacy Policy and will notify you of these changes by posting the modified terms on our Platforms. Your continued use of our services following any changes to this Privacy Policy constitutes your acceptance of the changes. We recommend that you revisit this Privacy Policy regularly.</p>
<p>&nbsp;</p>
<p>In addition, as per Article 77 of the GDPR, you have the right to lodge a complaint related to your data processing to a supervisory authority, in particular in the Member State of your habitual residence, place of work or place of an alleged infringement.</p>
<p>&nbsp;</p>
<p><strong>16. OTHER WEB SITES</strong></p>
<p>&nbsp;</p>
