...
<p style={{textAlign: "left"}}><span className='my-3' style={{fontSize: "18px"}}>At Zetto, we believe in being ‘UNCONVENTIONAL’</span></p>
<p style={{textAlign: "left"}}><p className='my-3' style={{fontSize: "18px"}}>Right from offering you the best in class customer service (that actually responds to you) to giving you the highest possible Welcome Bonus Gift at a whopping 100%, here at Zetto, we do things differently.</p></p>
...
<p><span style={{fontSize: "18px"}}>We're Zetto, and we're here to change the way you play.</span></p>
