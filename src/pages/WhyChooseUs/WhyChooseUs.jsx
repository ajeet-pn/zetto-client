...
<p style={{textAlign: "left"}}><span className='my-3' style={{fontSize: "18px"}}>At Minister777, we believe in being ‘UNCONVENTIONAL’</span></p>
<p style={{textAlign: "left"}}><p className='my-3' style={{fontSize: "18px"}}>Right from offering you the best in class customer service (that actually responds to you) to giving you the highest possible Welcome Bonus Gift at a whopping 100%, here at Minister777, we do things differently.</p></p>
...
<p><span style={{fontSize: "18px"}}>We're Minister777, and we're here to change the way you play.</span></p>
