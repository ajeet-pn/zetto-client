    ...
    <div className='mx-5 md:mx-20' >
      ...
      <ul className='ps-4'>
        ...
        <p className='text-[14px]'>In a traditional sportsbook, users bet against the bookmaker, while in a betting exchange, users bet against each other. Exchanges offer more flexibility as users can set their own odds and either back or lay a particular outcome.
          ...
          <p className='text-[14px] font-semibold'>3. Why does a user want to bet on the Bhimexch exchange in India?</p>
          <p className='text-[12px] py-2 '>
          ...
          <p className='text-[14px] font-semibold'>4. Is the Bhimexch betting exchange safe in India?</p>
          <p className='text-[12px] py-2 '>
          ...
          <p className='text-[14px] font-semibold'>5. Can I place in-play (live) bets on the Bhimexch betting exchange platform?</p>
          <p className='text-[12px] py-2 '>
