...
const isExcluded = excludedRoutes.includes(location.pathname);
    ...
    const hideSidebarRoutes = ['/responsible-gambling','/sport-view', "/login", "/sport-view-racing", '/deposit', "/wallet", "/all-casino", "/term-condition", "/promotions", "/casino-list-by-providername", "/privacy-policy", "/rules", "/about-us", "/contact-us", "/why-choose-us", '/iframe-'];
    const shouldHideSidebars = hideSidebarRoutes.some(route => currentPath.startsWith(route));


    const hideLeftSidebarRoutes = ['/responsible-gambling','/deposit', "/login", "/wallet", "/all-casino", "/term-condition", "/promotions", "/casino-list-by-providername", "/privacy-policy", "/rules", "/about-us", "/contact-us","/why-choose-us", '/iframe-'];
